                                ...
                                <div class="bg-white dark:bg-slate-800 rounded shadow-lg overflow-auto max-w-lg w-full max-h-full"
                                    ...
                                    <div class="px-5 py-3 border-b border-slate-200 dark:border-slate-700">
                                        <div class="flex justify-between items-center">
                                            <div class="font-semibold text-slate-800 dark:text-slate-100">Nueva Tarea
                                            </div>
                                            <button
                                    ...
                                    <div class="px-5 py-4">
                                        <div class="space-y-3 grid grid-cols-6 md:grid-cols-6">
                                            ...
                                            <div class="col-span-3 col-start-1">
                                                <label class="block text-sm font-medium mb-1" for="fecha_limite">Fecha
                                                    Límite</label>
                                    ...
                                    @foreach ($tareas as $tarea)
                                        <tr>
                                            ...
                                            <td class="px-2 first:pl-5 last:pr-5 py-3 whitespace-nowrap">
                                                ...
                                                <button wire:click.prevent="deleteConfirmation({{ $tarea }})"
