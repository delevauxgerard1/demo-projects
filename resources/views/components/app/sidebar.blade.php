        ...
        <div class="space-y-8">
            ...
            <div>
                ...
                <ul class="mt-3">
                    ...
                    <!-- Dashboard -->
                    <li
                        class="px-3 py-2 rounded-sm mb-0.5 last:mb-0 @if (Request::segment(1) === 'dashboard') {{ 'bg-slate-900' }} @endif">
                        <a class="block text-slate-200 hover:text-white truncate transition duration-150 @if (Request::segment(1) === 'dashboard') {{ 'hover:text-slate-200' }} @endif"
